...
function update_coefficients_julia!(indices, active::Vector{Int8}, β, β_unp, μinvσdif, μinvσ, λ_l, λ_r)
...
function cycle_coord_julia!(active::Vector{Int8}, β::Vector{Float64}, X::NestedMatrixBlocks, y::Vector{Float64}, 
    ...
    for XB in X.blocks
        ...
        update_coefficients_julia!(indices, active, β, β_unpenalized, μinvσdif, μinvσ, lasso_penalty, ridge_penalty)
...
function update_coefficients!(indices, active::Vector{Int8}, β, β_unp, μinvσdif, μinvσ, λ_l, λ_r)
    ...
    # Call the C function
    ccall((:coordinate_descent_update, "/var/home/salbalkus/.julia/dev/RandomHAL/deps/src/fastloop.so"), 
        Cvoid, 
